...
function turnOnLinux(opts) {
    ...
    const proxyPort = (_c = (_b = (_a = opts.userdata) === null || _a === void 0 ? void 0 : _a.proxy) === null || _b === void 0 ? void 0 : _b.port) !== null && _c !== void 0 ? _c : 0;
    if (!(0, utils_1.isPort)(proxyPort)) {
    ...
    const strs = [];
    if ((_e = (_d = opts.userdata) === null || _d === void 0 ? void 0 : _d.proxy) === null || _e === void 0 ? void 0 : _e.tproxy) {
        const mark = (_h = (_g = (_f = opts.userdata) === null || _f === void 0 ? void 0 : _f.proxy) === null || _g === void 0 ? void 0 : _g.mark) !== null && _h !== void 0 ? _h : 99;
        strs.push(`#!/bin/bash
set -e
